...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/12 14:48:30 by japatel           #+#    #+#             */
/*   Updated: 2024/02/04 18:49:46 by japatel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!check_file_read(fd, line2[fd]))
		return (NULL);
	line2[fd] = read_to_line(fd, line2[fd]);
	if (!line2[fd])
	{
		return (NULL);
	}
	line1 = ft_get_one_line(line2[fd]);
	line2[fd] = ft_get_new_line(line2[fd]);
	return (line1);
}
